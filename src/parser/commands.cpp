...
void EmptyCommand::invoke([[maybe_unused]] cvc5::Solver* solver,
                          [[maybe_unused]] SymManager* sm)
{
...
void EchoCommand::invoke([[maybe_unused]] cvc5::Solver* solver,
                         [[maybe_unused]] SymManager* sm)
{
  d_commandStatus = CommandSuccess::instance();
}

void EchoCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
...
void AssertCommand::invoke(cvc5::Solver* solver,
                           [[maybe_unused]] SymManager* sm)
{
  try
  {
...
void PushCommand::invoke(cvc5::Solver* solver, [[maybe_unused]] SymManager* sm)
{
  try
  {
...
void PopCommand::invoke(cvc5::Solver* solver, [[maybe_unused]] SymManager* sm)
{
  try
  {
...
void CheckSatCommand::invoke(cvc5::Solver* solver,
                             [[maybe_unused]] SymManager* sm)
{
...
void CheckSatCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
                                  std::ostream& out) const
{
  out << d_result << endl;
}
...
void CheckSatAssumingCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
                                          std::ostream& out) const
{
  out << d_result << endl;
}
...
void CheckSynthCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
                                    std::ostream& out) const
{
  out << d_solution.str();
}
...
void FindSynthCommand::invoke(cvc5::Solver* solver,
                              [[maybe_unused]] SymManager* sm)
{
  try
  {
...
void FindSynthCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
                                   std::ostream& out) const
{
  if (d_result.isNull())
  {
...
void FindSynthNextCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
                                       std::ostream& out) const
{
  if (d_result.isNull())
  {
...
void QuitCommand::invoke([[maybe_unused]] cvc5::Solver* solver,
                         [[maybe_unused]] SymManager* sm)
{
  d_commandStatus = CommandSuccess::instance();
}
...
void DeclareOracleFunCommand::invoke([[maybe_unused]] Solver* solver,
                                     [[maybe_unused]] SymManager* sm)
{
...
void DefineSortCommand::invoke([[maybe_unused]] cvc5::Solver* solver,
                               SymManager* sm)
{
...
void SimplifyCommand::invoke(cvc5::Solver* solver,
                             [[maybe_unused]] SymManager* sm)
{
  try
  {
...
void SimplifyCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
                                  std::ostream& out) const
{
  out << d_result << endl;
}
...
void GetValueCommand::invoke(cvc5::Solver* solver,
                             [[maybe_unused]] SymManager* sm)
{
  try
  {
...
void GetValueCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
                                  std::ostream& out) const
{
  Assert(d_result.size() == d_terms.size());
...
void GetModelDomainElementsCommand::printResult(
    [[maybe_unused]] cvc5::Solver* solver, std::ostream& out) const
{
  out << "(";
  bool firstTime = true;
  for (size_t i = 0, rsize = d_result.size(); i < rsize; i++)
...
void GetAssignmentCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
                                       std::ostream& out) const
{
  out << d_result << endl;
}
...
void GetModelCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
                                  std::ostream& out) const
{
  out << d_result;
}
...
void BlockModelCommand::invoke(cvc5::Solver* solver,
                               [[maybe_unused]] SymManager* sm)
{
  try
  {
...
void GetProofCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
                                  std::ostream& out) const
{
  out << d_result;
}
...
bool GetInstantiationsCommand::isEnabled([[maybe_unused]] cvc5::Solver* solver,
...
void GetInstantiationsCommand::printResult(
    [[maybe_unused]] cvc5::Solver* solver, std::ostream& out) const
{
...
void GetInterpolantCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
                                        std::ostream& out) const
{
  if (!d_result.isNull())
  {
...
void GetInterpolantNextCommand::printResult(
    [[maybe_unused]] cvc5::Solver* solver, std::ostream& out) const
{
  if (!d_result.isNull())
  {
...
void GetAbductCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
                                   std::ostream& out) const
{
  if (!d_result.isNull())
  {
...
void GetAbductNextCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
                                       std::ostream& out) const
{
  if (!d_result.isNull())
  {
...
void GetUnsatAssumptionsCommand::printResult(
    [[maybe_unused]] cvc5::Solver* solver, std::ostream& out) const
{
...
void GetUnsatCoreCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
                                      std::ostream& out) const
{
...
void GetUnsatCoreLemmasCommand::printResult(
    [[maybe_unused]] cvc5::Solver* solver, std::ostream& out) const
{
  // use the assertions
  internal::UnsatCore ucr(termVectorToNodes(d_result));
...
void GetDifficultyCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
                                       std::ostream& out) const
{
  out << "(" << std::endl;
...
void GetTimeoutCoreCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
                                        std::ostream& out) const
{
...
void GetLearnedLiteralsCommand::printResult(
    [[maybe_unused]] cvc5::Solver* solver, std::ostream& out) const
{
  out << "(" << std::endl;
...
void GetAssertionsCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
                                       std::ostream& out) const
{
  out << d_result;
}
...
void SetInfoCommand::invoke(cvc5::Solver* solver,
                            [[maybe_unused]] SymManager* sm)
{
  try
  {
...
void GetInfoCommand::invoke(cvc5::Solver* solver,
                            [[maybe_unused]] SymManager* sm)
{
  try
  {
...
void GetInfoCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
                                 std::ostream& out) const
{
  if (d_result != "")
  {
...
void SetOptionCommand::invoke(cvc5::Solver* solver,
                              [[maybe_unused]] SymManager* sm)
{
  try
  {
...
void GetOptionCommand::invoke(cvc5::Solver* solver,
                              [[maybe_unused]] SymManager* sm)
{
  try
  {
...
void GetOptionCommand::printResult([[maybe_unused]] cvc5::Solver* solver,
                                   std::ostream& out) const
{
  if (d_result != "")
  {
