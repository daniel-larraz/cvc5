...
class ProofRule(DocEnum):
    """The ProofRule enum"""
    ASSUME=c_ProofRule.ASSUME, """\\verbatim embed:rst:leading-asterisk
**Assumption (a leaf)**
...
bound by :py:obj:`SCOPE <cvc5::ProofRule::SCOPE>` (see below).
\\endverbatim"""
    SCOPE=c_ProofRule.SCOPE, """\\verbatim embed:rst:leading-asterisk
...
formula. \\endverbatim"""
    SUBS=c_ProofRule.SUBS, """\\verbatim embed:rst:leading-asterisk
...
:math:`x\\mapsto y`. \\endverbatim"""
    MACRO_REWRITE=c_ProofRule.MACRO_REWRITE, """\\verbatim embed:rst:leading-asterisk
...
rewriter to apply, e.g. Rewriter::rewrite. \\endverbatim"""
    EVALUATE=c_ProofRule.EVALUATE, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    MACRO_SR_EQ_INTRO=c_ProofRule.MACRO_SR_EQ_INTRO, """\\verbatim embed:rst:leading-asterisk
...
:cvc5src:`theory/builtin/proof_checker.h`. \\endverbatim"""
    MACRO_SR_PRED_INTRO=c_ProofRule.MACRO_SR_PRED_INTRO, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    MACRO_SR_PRED_ELIM=c_ProofRule.MACRO_SR_PRED_ELIM, """\\verbatim embed:rst:leading-asterisk
...
:py:obj:`MACRO_SR_EQ_INTRO <cvc5::ProofRule::MACRO_SR_EQ_INTRO>`.
\\endverbatim"""
    MACRO_SR_PRED_TRANSFORM=c_ProofRule.MACRO_SR_PRED_TRANSFORM, """\\verbatim embed:rst:leading-asterisk
**Builtin theory -- Substitution + Rewriting predicate elimination**
...
:py:obj:`MACRO_SR_PRED_INTRO <cvc5::ProofRule::MACRO_SR_PRED_INTRO>`
above. \\endverbatim"""
    ENCODE_PRED_TRANSFORM=c_ProofRule.ENCODE_PRED_TRANSFORM, """\\verbatim embed:rst:leading-asterisk
...
formats.
\\endverbatim"""
    DSL_REWRITE=c_ProofRule.DSL_REWRITE, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ANNOTATION=c_ProofRule.ANNOTATION, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    REMOVE_TERM_FORMULA_AXIOM=c_ProofRule.REMOVE_TERM_FORMULA_AXIOM, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    TRUST=c_ProofRule.TRUST, """\\verbatim embed:rst:leading-asterisk
**Trusted rule**
...
\\endverbatim"""
    TRUST_THEORY_REWRITE=c_ProofRule.TRUST_THEORY_REWRITE, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    SAT_REFUTATION=c_ProofRule.SAT_REFUTATION, """\\verbatim embed:rst:leading-asterisk
...
SAT solver. \\endverbatim"""
    RESOLUTION=c_ProofRule.RESOLUTION, """\\verbatim embed:rst:leading-asterisk
**Boolean -- Resolution**
...
literal eliminated.
\\endverbatim"""
    CHAIN_RESOLUTION=c_ProofRule.CHAIN_RESOLUTION, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    FACTORING=c_ProofRule.FACTORING, """\\verbatim embed:rst:leading-asterisk
**Boolean -- Factoring**
...
\\endverbatim"""
    REORDERING=c_ProofRule.REORDERING, """\\verbatim embed:rst:leading-asterisk
**Boolean -- Reordering**
...
\\endverbatim"""
    MACRO_RESOLUTION=c_ProofRule.MACRO_RESOLUTION, """\\verbatim embed:rst:leading-asterisk
...
- let :math:`C_1 \\dots C_n` be nodes viewed as clauses, as defined in
  :py:obj:`RESOLUTION <cvc5::ProofRule::RESOLUTION>`
...
\\endverbatim"""
    MACRO_RESOLUTION_TRUST=c_ProofRule.MACRO_RESOLUTION_TRUST, """\\verbatim embed:rst:leading-asterisk
...
checker. \\endverbatim"""
    SPLIT=c_ProofRule.SPLIT, """\\verbatim embed:rst:leading-asterisk
**Boolean -- Split**
...
\\endverbatim"""
    EQ_RESOLVE=c_ProofRule.EQ_RESOLVE, """\\verbatim embed:rst:leading-asterisk
...
:py:obj:`EQUIV_ELIM1 <cvc5::ProofRule::EQUIV_ELIM1>` +
:py:obj:`RESOLUTION <cvc5::ProofRule::RESOLUTION>`.
\\endverbatim"""
    MODUS_PONENS=c_ProofRule.MODUS_PONENS, """\\verbatim embed:rst:leading-asterisk
...
Note this can optionally be seen as a macro for
:py:obj:`IMPLIES_ELIM <cvc5::ProofRule::IMPLIES_ELIM>` +
:py:obj:`RESOLUTION <cvc5::ProofRule::RESOLUTION>`.
\\endverbatim"""
    NOT_NOT_ELIM=c_ProofRule.NOT_NOT_ELIM, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CONTRA=c_ProofRule.CONTRA, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    AND_ELIM=c_ProofRule.AND_ELIM, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    AND_INTRO=c_ProofRule.AND_INTRO, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    NOT_OR_ELIM=c_ProofRule.NOT_OR_ELIM, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    IMPLIES_ELIM=c_ProofRule.IMPLIES_ELIM, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    NOT_IMPLIES_ELIM1=c_ProofRule.NOT_IMPLIES_ELIM1, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    NOT_IMPLIES_ELIM2=c_ProofRule.NOT_IMPLIES_ELIM2, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    EQUIV_ELIM1=c_ProofRule.EQUIV_ELIM1, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    EQUIV_ELIM2=c_ProofRule.EQUIV_ELIM2, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    NOT_EQUIV_ELIM1=c_ProofRule.NOT_EQUIV_ELIM1, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    NOT_EQUIV_ELIM2=c_ProofRule.NOT_EQUIV_ELIM2, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    XOR_ELIM1=c_ProofRule.XOR_ELIM1, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    XOR_ELIM2=c_ProofRule.XOR_ELIM2, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    NOT_XOR_ELIM1=c_ProofRule.NOT_XOR_ELIM1, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    NOT_XOR_ELIM2=c_ProofRule.NOT_XOR_ELIM2, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ITE_ELIM1=c_ProofRule.ITE_ELIM1, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ITE_ELIM2=c_ProofRule.ITE_ELIM2, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    NOT_ITE_ELIM1=c_ProofRule.NOT_ITE_ELIM1, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    NOT_ITE_ELIM2=c_ProofRule.NOT_ITE_ELIM2, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    NOT_AND=c_ProofRule.NOT_AND, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_AND_POS=c_ProofRule.CNF_AND_POS, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_AND_NEG=c_ProofRule.CNF_AND_NEG, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_OR_POS=c_ProofRule.CNF_OR_POS, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_OR_NEG=c_ProofRule.CNF_OR_NEG, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_IMPLIES_POS=c_ProofRule.CNF_IMPLIES_POS, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_IMPLIES_NEG1=c_ProofRule.CNF_IMPLIES_NEG1, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_IMPLIES_NEG2=c_ProofRule.CNF_IMPLIES_NEG2, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_EQUIV_POS1=c_ProofRule.CNF_EQUIV_POS1, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_EQUIV_POS2=c_ProofRule.CNF_EQUIV_POS2, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_EQUIV_NEG1=c_ProofRule.CNF_EQUIV_NEG1, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_EQUIV_NEG2=c_ProofRule.CNF_EQUIV_NEG2, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_XOR_POS1=c_ProofRule.CNF_XOR_POS1, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_XOR_POS2=c_ProofRule.CNF_XOR_POS2, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_XOR_NEG1=c_ProofRule.CNF_XOR_NEG1, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_XOR_NEG2=c_ProofRule.CNF_XOR_NEG2, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_ITE_POS1=c_ProofRule.CNF_ITE_POS1, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_ITE_POS2=c_ProofRule.CNF_ITE_POS2, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_ITE_POS3=c_ProofRule.CNF_ITE_POS3, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_ITE_NEG1=c_ProofRule.CNF_ITE_NEG1, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_ITE_NEG2=c_ProofRule.CNF_ITE_NEG2, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CNF_ITE_NEG3=c_ProofRule.CNF_ITE_NEG3, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    REFL=c_ProofRule.REFL, """\\verbatim embed:rst:leading-asterisk
...
.. math::
  ...
  \\inferrule{-\\mid t}{t = t}
\\endverbatim"""
    SYMM=c_ProofRule.SYMM, """\\verbatim embed:rst:leading-asterisk
**Equality -- Symmetry**
...
\\endverbatim"""
    TRANS=c_ProofRule.TRANS, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CONG=c_ProofRule.CONG, """\\verbatim embed:rst:leading-asterisk
**Equality -- Congruence**
...
use the :py:obj:`HO_CONG <cvc5::ProofRule::HO_CONG>` proof rule.
\\endverbatim"""
    NARY_CONG=c_ProofRule.NARY_CONG, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    TRUE_INTRO=c_ProofRule.TRUE_INTRO, """\\verbatim embed:rst:leading-asterisk
**Equality -- True intro**
...
\\endverbatim"""
    TRUE_ELIM=c_ProofRule.TRUE_ELIM, """\\verbatim embed:rst:leading-asterisk
**Equality -- True elim**
...
\\endverbatim"""
    FALSE_INTRO=c_ProofRule.FALSE_INTRO, """\\verbatim embed:rst:leading-asterisk
...
.. math::
  ...
  \\inferrule{\\neg F\\mid -}{F = \\bot}
\\endverbatim"""
    FALSE_ELIM=c_ProofRule.FALSE_ELIM, """\\verbatim embed:rst:leading-asterisk
**Equality -- False elim**
...
.. math::
  ...
  \\inferrule{F=\\bot\\mid -}{\\neg F}
\\endverbatim"""
    HO_APP_ENCODE=c_ProofRule.HO_APP_ENCODE, """\\verbatim embed:rst:leading-asterisk
...
:math:`@` isthe ``HO_APPLY`` kind.
 \\endverbatim"""
    HO_CONG=c_ProofRule.HO_CONG, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    BETA_REDUCE=c_ProofRule.BETA_REDUCE, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ARRAYS_READ_OVER_WRITE=c_ProofRule.ARRAYS_READ_OVER_WRITE, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ARRAYS_READ_OVER_WRITE_CONTRA=c_ProofRule.ARRAYS_READ_OVER_WRITE_CONTRA, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ARRAYS_READ_OVER_WRITE_1=c_ProofRule.ARRAYS_READ_OVER_WRITE_1, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ARRAYS_EXT=c_ProofRule.ARRAYS_EXT, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ARRAYS_EQ_RANGE_EXPAND=c_ProofRule.ARRAYS_EQ_RANGE_EXPAND, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    MACRO_BV_BITBLAST=c_ProofRule.MACRO_BV_BITBLAST, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    BV_BITBLAST_STEP=c_ProofRule.BV_BITBLAST_STEP, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    BV_EAGER_ATOM=c_ProofRule.BV_EAGER_ATOM, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    DT_UNIF=c_ProofRule.DT_UNIF, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    DT_INST=c_ProofRule.DT_INST, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    DT_COLLAPSE=c_ProofRule.DT_COLLAPSE, """\\verbatim embed:rst:leading-asterisk
**Datatypes -- Collapse**
...
\\endverbatim"""
    DT_SPLIT=c_ProofRule.DT_SPLIT, """\\verbatim embed:rst:leading-asterisk
**Datatypes -- Split**
...
\\endverbatim"""
    DT_CLASH=c_ProofRule.DT_CLASH, """\\verbatim embed:rst:leading-asterisk
**Datatypes -- Clash**
...
\\endverbatim"""
    SKOLEM_INTRO=c_ProofRule.SKOLEM_INTRO, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    SKOLEMIZE=c_ProofRule.SKOLEMIZE, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    INSTANTIATE=c_ProofRule.INSTANTIATE, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ALPHA_EQUIV=c_ProofRule.ALPHA_EQUIV, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CONCAT_EQ=c_ProofRule.CONCAT_EQ, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CONCAT_UNIFY=c_ProofRule.CONCAT_UNIFY, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CONCAT_CONFLICT=c_ProofRule.CONCAT_CONFLICT, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CONCAT_CONFLICT_DEQ=c_ProofRule.CONCAT_CONFLICT_DEQ, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CONCAT_SPLIT=c_ProofRule.CONCAT_SPLIT, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CONCAT_CSPLIT=c_ProofRule.CONCAT_CSPLIT, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    CONCAT_LPROP=c_ProofRule.CONCAT_LPROP, """\\verbatim embed:rst:leading-asterisk
...
\\mathit{len}(s_2)))`.
\\endverbatim"""
    CONCAT_CPROP=c_ProofRule.CONCAT_CPROP, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    STRING_DECOMPOSE=c_ProofRule.STRING_DECOMPOSE, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    STRING_LENGTH_POS=c_ProofRule.STRING_LENGTH_POS, """\\verbatim embed:rst:leading-asterisk
...
.. math::
  ...
  > 0}
\\endverbatim"""
    STRING_LENGTH_NON_EMPTY=c_ProofRule.STRING_LENGTH_NON_EMPTY, """\\verbatim embed:rst:leading-asterisk
...
.. math::
  ...
  \\inferrule{t\\neq ''\\mid -}{\\mathit{len}(t) \\neq 0}
\\endverbatim"""
    STRING_REDUCTION=c_ProofRule.STRING_REDUCTION, """\\verbatim embed:rst:leading-asterisk
...
variables of :math:`t`.
\\endverbatim"""
    STRING_EAGER_REDUCTION=c_ProofRule.STRING_EAGER_REDUCTION, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    RE_INTER=c_ProofRule.RE_INTER, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    RE_UNFOLD_POS=c_ProofRule.RE_UNFOLD_POS, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    RE_UNFOLD_NEG=c_ProofRule.RE_UNFOLD_NEG, """\\verbatim embed:rst:leading-asterisk
...
corresponding to the one-step unfolding of the premise.
\\endverbatim"""
    RE_UNFOLD_NEG_CONCAT_FIXED=c_ProofRule.RE_UNFOLD_NEG_CONCAT_FIXED, """\\verbatim embed:rst:leading-asterisk
...
:math:`R`.
\\endverbatim"""
    RE_ELIM=c_ProofRule.RE_ELIM, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    STRING_CODE_INJ=c_ProofRule.STRING_CODE_INJ, """\\verbatim embed:rst:leading-asterisk
**Strings -- Code points**
...
\\endverbatim"""
    STRING_SEQ_UNIT_INJ=c_ProofRule.STRING_SEQ_UNIT_INJ, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    MACRO_STRING_INFERENCE=c_ProofRule.MACRO_STRING_INFERENCE, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    MACRO_ARITH_SCALE_SUM_UB=c_ProofRule.MACRO_ARITH_SCALE_SUM_UB, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ARITH_SUM_UB=c_ProofRule.ARITH_SUM_UB, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    INT_TIGHT_UB=c_ProofRule.INT_TIGHT_UB, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    INT_TIGHT_LB=c_ProofRule.INT_TIGHT_LB, """\\verbatim embed:rst:leading-asterisk
...
where :math:`i` has integer type.
\\endverbatim"""
    ARITH_TRICHOTOMY=c_ProofRule.ARITH_TRICHOTOMY, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ARITH_OP_ELIM_AXIOM=c_ProofRule.ARITH_OP_ELIM_AXIOM, """\\verbatim embed:rst:leading-asterisk
**Arithmetic -- Operator elimination**

.. math::
  \\inferrule{- \\mid t}{\\texttt{arith::OperatorElim::getAxiomFor(t)}}
\\endverbatim"""
    ARITH_POLY_NORM=c_ProofRule.ARITH_POLY_NORM, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ARITH_MULT_SIGN=c_ProofRule.ARITH_MULT_SIGN, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ARITH_MULT_POS=c_ProofRule.ARITH_MULT_POS, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ARITH_MULT_NEG=c_ProofRule.ARITH_MULT_NEG, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ARITH_MULT_TANGENT=c_ProofRule.ARITH_MULT_TANGENT, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ARITH_TRANS_PI=c_ProofRule.ARITH_TRANS_PI, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ARITH_TRANS_EXP_NEG=c_ProofRule.ARITH_TRANS_EXP_NEG, """\\verbatim embed:rst:leading-asterisk
**Arithmetic -- Transcendentals -- Exp at negative values**

.. math::
  \\inferrule{- \\mid t}{(t < 0) \\leftrightarrow (\\exp(t) < 1)}
\\endverbatim"""
    ARITH_TRANS_EXP_POSITIVITY=c_ProofRule.ARITH_TRANS_EXP_POSITIVITY, """\\verbatim embed:rst:leading-asterisk
**Arithmetic -- Transcendentals -- Exp is always positive**

.. math::
  \\inferrule{- \\mid t}{\\exp(t) > 0}
\\endverbatim"""
    ARITH_TRANS_EXP_SUPER_LIN=c_ProofRule.ARITH_TRANS_EXP_SUPER_LIN, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ARITH_TRANS_EXP_ZERO=c_ProofRule.ARITH_TRANS_EXP_ZERO, """\\verbatim embed:rst:leading-asterisk
**Arithmetic -- Transcendentals -- Exp at zero**

.. math::
  \\inferrule{- \\mid t}{(t=0) \\leftrightarrow (\\exp(t) = 1)}
\\endverbatim"""
    ARITH_TRANS_EXP_APPROX_ABOVE_NEG=c_ProofRule.ARITH_TRANS_EXP_APPROX_ABOVE_NEG, """\\verbatim embed:rst:leading-asterisk
...
:math:`u`. \\endverbatim"""
    ARITH_TRANS_EXP_APPROX_ABOVE_POS=c_ProofRule.ARITH_TRANS_EXP_APPROX_ABOVE_POS, """\\verbatim embed:rst:leading-asterisk
**Arithmetic -- Transcendentals -- Exp is approximated from above for
positive values**
...
:math:`\\exp(t` is below the secant of :math:`p` from :math:`l` to
:math:`u`. \\endverbatim"""
    ARITH_TRANS_EXP_APPROX_BELOW=c_ProofRule.ARITH_TRANS_EXP_APPROX_BELOW, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ARITH_TRANS_SINE_BOUNDS=c_ProofRule.ARITH_TRANS_SINE_BOUNDS, """\\verbatim embed:rst:leading-asterisk
**Arithmetic -- Transcendentals -- Sine is always between -1 and 1**

.. math::
  \\inferrule{- \\mid t}{\\sin(t) \\leq 1 \\land \\sin(t) \\geq -1}
\\endverbatim"""
    ARITH_TRANS_SINE_SHIFT=c_ProofRule.ARITH_TRANS_SINE_SHIFT, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ARITH_TRANS_SINE_SYMMETRY=c_ProofRule.ARITH_TRANS_SINE_SYMMETRY, """\\verbatim embed:rst:leading-asterisk
...
\\endverbatim"""
    ARITH_TRANS_SINE_TANGENT_ZERO=c_ProofRule.ARITH_TRANS_SINE_TANGENT_ZERO, """\\verbatim embed:rst:leading-asterisk
...
.. math::
  ...
  \\rightarrow \\sin(t) > t)} \\endverbatim"""
    ARITH_TRANS_SINE_TANGENT_PI=c_ProofRule.ARITH_TRANS_SINE_TANGENT_PI, """\\verbatim embed:rst:leading-asterisk
...
.. math::
  ...
  \\pi \\rightarrow \\sin(t) < \\pi - t)} \\endverbatim"""
    ARITH_TRANS_SINE_APPROX_ABOVE_NEG=c_ProofRule.ARITH_TRANS_SINE_APPROX_ABOVE_NEG, """\\verbatim embed:rst:leading-asterisk
...
:math:`u`. \\endverbatim"""
    ARITH_TRANS_SINE_APPROX_ABOVE_POS=c_ProofRule.ARITH_TRANS_SINE_APPROX_ABOVE_POS, """\\verbatim embed:rst:leading-asterisk
**Arithmetic -- Transcendentals -- Sine is approximated from above for
positive values**
...
:math:`(lb,ub)`. \\endverbatim"""
    ARITH_TRANS_SINE_APPROX_BELOW_NEG=c_ProofRule.ARITH_TRANS_SINE_APPROX_BELOW_NEG, """\\verbatim embed:rst:leading-asterisk
...
:math:`(lb,ub)`. \\endverbatim"""
    ARITH_TRANS_SINE_APPROX_BELOW_POS=c_ProofRule.ARITH_TRANS_SINE_APPROX_BELOW_POS, """\\verbatim embed:rst:leading-asterisk
**Arithmetic -- Transcendentals -- Sine is approximated from below for
positive values**
...
:math:`u`. \\endverbatim"""
    ARITH_NL_COVERING_DIRECT=c_ProofRule.ARITH_NL_COVERING_DIRECT, """\\verbatim embed:rst:leading-asterisk
...
the cell. \\endverbatim"""
    ARITH_NL_COVERING_RECURSIVE=c_ProofRule.ARITH_NL_COVERING_RECURSIVE, """\\verbatim embed:rst:leading-asterisk
**Arithmetic -- Coverings -- Recursive interval**

See
:py:obj:`ARITH_NL_COVERING_DIRECT <cvc5::ProofRule::ARITH_NL_COVERING_DIRECT>`
...
\\endverbatim"""
    LFSC_RULE=c_ProofRule.LFSC_RULE, """\\verbatim embed:rst:leading-asterisk
**External -- LFSC**
...
\\endverbatim"""
    ALETHE_RULE=c_ProofRule.ALETHE_RULE, """\\verbatim embed:rst:leading-asterisk
**External -- Alethe**
...
printer.
\\endverbatim"""
    UNKNOWN=c_ProofRule.UNKNOWN, """\\verbatim embed:rst:leading-asterisk
**External -- Alethe**
